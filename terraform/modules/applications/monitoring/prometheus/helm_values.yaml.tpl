...
server:
  ...
  persistentVolume:
    ...
    ##   GKE, AWS & OpenStack)
    ##
    storageClass: ${serverVolumeStorageClass}
...
alertmanager:
  ...
  persistence:
    storageClass: ${alertmanagerVolumeStorageClass}
    size: ${alertmanagerVolumeSize}
...
prometheus-node-exporter:
  ...
  hostRootFsMount:
    enabled: ${nodeExporterHostRootFsMount}
